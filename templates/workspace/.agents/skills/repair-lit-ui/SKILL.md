...
After repair, rerun the failing check plus `validate:lit-ui`. If a source or Mapping decision must change, return to `$lit-ui-workflow` and require reconfirmation.
